...
const cal = document.querySelectorAll('.calendar')
if (innerWidth > 992) {
  cal[0]?.remove()
}
    ...
    const calendarControl = {
      ...
      plotSelectors: function () {
        ...
        <div class="calendar-inner">
          ...
          <div class="calendar-title">Выберите дату</div>
      ...
      attachEvents: function () {
        let prevBtn = document.querySelector('.calendar .calendar-prev div')
        let nextBtn = document.querySelector('.calendar .calendar-next div')
